				...
				<div class="panel-body form-group form-group-sm">
					<div class="row">
						<div class="col-xs-6">
							...
							<div class="form-group">
								<input type="text" class="form-control margin-bottom copy-input required" name="customer_town" id="customer_town" placeholder="City Town" tabindex="5">		
							</div>
						...
						<div class="col-xs-6">
							<div class="input-group float-right margin-bottom">
								...
								<input type="email" class="form-control copy-input" name="customer_email" id="customer_email" placeholder="E-mail address(optional)" aria-describedby="sizing-addon1" tabindex="2">
							</div>
						    <div class="form-group">
						    	<input type="text" class="form-control margin-bottom copy-input" name="customer_address_2" id="customer_address_2" placeholder="Sevice Type" tabindex="4">
						    </div>
						    <div class="form-group">
				...
				<div class="panel-body form-group form-group-sm">
					<div class="row">
						...
						<div class="col-xs-6">
							...
							<div class="form-group">
								<input type="text" class="form-control margin-bottom required" name="customer_town_ship" id="customer_town_ship" placeholder="City Town" tabindex="12">							
						    </div>
						    <div class="form-group no-margin-bottom">
