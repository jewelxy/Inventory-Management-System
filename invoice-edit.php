...
<span><a href="invoice-create.php" style="float:right;" class="btn btn-success">Back</a></span>

		<h1>Invoice No: <?php echo $getID; ?></h1>
		<hr>
		...
		<form method="post" id="update_invoice">
						...
						<div class="panel-body form-group form-group-sm">
							<div class="row">
								<div class="col-xs-6">
									...
									<div class="form-group">
									Address: <?php echo $customer_address_1; ?>
									</div>
									<div class="form-group">
									Town or City: <?php echo $customer_town; ?>
									</div>
									<div class="form-group no-margin-bottom">
									Post Code: <?php echo $customer_postcode; ?>
									</div>
								</div>
								<div class="col-xs-6">
									<div class="input-group float-right margin-bottom">
										<span class="input-group-addon"><!--@--></span>
									Email (Optional) : <?php echo $customer_email; ?>
									</div>
								    <div class="form-group">
								    Service List: <?php echo $customer_address_2; ?>
									</div>
								    <div class="form-group">
								    Customer Id: <?php echo $customer_county; ?>
									</div>
								    <div class="form-group no-margin-bottom">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body form-group form-group-sm">
							<div class="row">
								<div class="col-xs-6">
									<div class="form-group">
									Name : <?php echo $customer_name_ship; ?>
									</div>
									<div class="form-group">
									Service List : <?php echo $customer_address_2_ship; ?>
									</div>
									<div class="form-group no-margin-bottom">
									Country : <?php echo $customer_county_ship; ?>
									</div>
								</div>
								<div class="col-xs-6">
									<div class="form-group">
								   Address : <?php echo $customer_address_1_ship; ?>
									</div>
									<div class="form-group">
									City Town : <?php echo $customer_town_ship; ?> 
									</div>
								    <div class="form-group no-margin-bottom">
								    Post Code : <?php echo $customer_postcode_ship; ?>
									</div>
								</div>
							</div>
						</div>
			...
			<table class="table table-bordered" id="invoice_table">
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-right">
							<div class="form-group form-group-sm  no-margin-bottom">
								<!---<input type="text" class="form-control calculate" name="invoice_product_discount[]" placeholder="Enter % or value" value="<?php //echo $item_discount; ?>">--->
							<?php echo $item_discount; ?>
							</div>
						</td>
						<td class="text-right">
							<div class="input-group input-group-sm">
								<span class="input-group-addon disabled"><?php echo CURRENCY ?></span>
			...
			<div id="invoice_totals" class="padding-right row text-right">
				...
				<div class="col-xs-6 no-padding-right">
					...
					<!---<div class="row">
						<div class="col-xs-3 col-xs-offset-6">
							<strong class="shipping">Shipping Fee:</strong>
						</div>
						<div class="col-xs-3">
							<div class="input-group input-group-sm">
								<span class="input-group-addon"><?php //echo CURRENCY ?></span>
