				...
				<div class="col-xs-6">
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<a href="#" class="float-right select-customer">Select from customer list</a>
							<div class="clear"></div>
						</div>
						<div class="panel-body form-group form-group-sm">
							<div class="row">
								<div class="col-xs-6">
									...
									<div class="form-group">
										<input type="text" class="form-control margin-bottom copy-input required" name="customer_town" id="customer_town" placeholder="Town or City" tabindex="5">		
									</div>
								...
								<div class="col-xs-6">
									<div class="input-group float-right margin-bottom">
										...
										<input type="email" class="form-control copy-input" name="customer_email" id="customer_email" placeholder="E-mail address" aria-describedby="sizing-addon1" tabindex="2">
									</div>
								    <div class="form-group">
								    	<input type="text" class="form-control margin-bottom copy-input" name="customer_address_2" id="customer_address_2" placeholder="Service Type" tabindex="4">
								    </div>
								    <div class="form-group">
								    	<input type="text" class="form-control margin-bottom copy-input required" name="customer_county" id="customer_county" placeholder="Customer Id" tabindex="6">
								    </div>
								    <div class="form-group no-margin-bottom">
						...
						<div class="panel-body form-group form-group-sm">
							<div class="row">
								<div class="col-xs-6">
									...
									<div class="form-group">
										<input type="text" class="form-control margin-bottom" name="customer_address_2_ship" id="customer_address_2_ship" placeholder="Service Type" tabindex="11">	
									</div>
									<div class="form-group no-margin-bottom">
										<input type="text" class="form-control required" name="customer_county_ship" id="customer_county_ship" placeholder="Customer Id" tabindex="13">
									</div>
								</div>
								<div class="col-xs-6">
									<div class="form-group">
									...
									<div class="form-group">
										<input type="text" class="form-control margin-bottom required" name="customer_town_ship" id="customer_town_ship" placeholder="Town or City" tabindex="12">							
								    </div>
								    <div class="form-group no-margin-bottom">
					...
					<tr>
						<td>
							<div class="form-group form-group-sm  no-margin-bottom">
								...
								<p class="item-select">or <a href="#">select from item list</a></p>
							</div>
						</td>
						<td class="text-right">
							<div class="form-group form-group-sm no-margin-bottom">
						...
						<td class="text-right">
							<div class="form-group form-group-sm  no-margin-bottom">
								<input type="text" class="form-control calculate" name="invoice_product_discount[]" placeholder="Enter % or value">
							</div>
						</td>
						<td class="text-right">
