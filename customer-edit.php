...
<form method="post" id="update_customer">
	...
	<div class="row">
				...
				<div class="panel-body form-group form-group-sm">
					<div class="row">
						<div class="col-xs-6">
							...
							<div class="form-group">
								<input type="text" class="form-control margin-bottom copy-input required" name="customer_address_1" id="customer_address_1" placeholder="Address" tabindex="3" value="<?php echo $customer_address_1; ?>">	
							</div>
							<div class="form-group">
								<input type="text" class="form-control margin-bottom copy-input required" name="customer_town" id="customer_town" placeholder="City Town" tabindex="5" value="<?php echo $customer_town; ?>">		
							</div>
						...
						<div class="col-xs-6">
						    ...
						    <div class="form-group">
						    	<input type="text" class="form-control margin-bottom copy-input" name="customer_address_2" id="customer_address_2" placeholder="Sevice Type" tabindex="4" value="<?php echo $customer_address_2; ?>">
						    </div>
						    <div class="form-group">
						    	<input type="text" class="form-control margin-bottom copy-input required" name="customer_county" id="customer_county" placeholder="Customer Id" tabindex="6" value="<?php echo $customer_county; ?>">
						    </div>
						    <div class="form-group no-margin-bottom">
		...
		<div class="col-xs-6 text-right">
			<div class="panel panel-default">
				<div class="panel-heading">
					<h4>Customer Invoice Information</h4>
				</div>
				<div class="panel-body form-group form-group-sm">
					<div class="row">
						<div class="col-xs-6">
							...
							<div class="form-group">
								<input type="text" class="form-control margin-bottom" name="customer_address_2_ship" id="customer_address_2_ship" placeholder="Sevice Type" tabindex="11" value="<?php echo $customer_address_2_ship; ?>">	
							</div>
							<div class="form-group no-margin-bottom">
								<input type="text" class="form-control required" name="customer_county_ship" id="customer_county_ship" placeholder="Customer Id" tabindex="13" value="<?php echo $customer_county_ship; ?>">
							</div>
						</div>
						<div class="col-xs-6">
							<div class="form-group">
						    	<input type="text" class="form-control margin-bottom required" name="customer_address_1_ship" id="customer_address_1_ship" placeholder="Address" tabindex="10" value="<?php echo $customer_address_1_ship; ?>">
							</div>
							<div class="form-group">
								<input type="text" class="form-control margin-bottom required" name="customer_town_ship" id="customer_town_ship" placeholder="City Town" tabindex="12" value="<?php echo $customer_town_ship; ?>">							
						    </div>
						    <div class="form-group no-margin-bottom">
