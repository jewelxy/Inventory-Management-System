...
<div class="wrapper">
  ...
  <header class="main-header">
     ...
     <!--Logo -->
    <a href="invoice-create.php" class="logo">
       <!--mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini"><b>Cb</b>Nt</span>
       <!--logo for regular state and mobile devices -->
      <span class="logo-lg"><b>Cable</b>Invoice</span>
    </a>
        ...
        <!-- Menu 1 -->
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="invoice-list.php"><i class="fa fa-cog"></i>Invoices List</a></li>
        ...
        <!-- Menu 2 -->
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="product-list.php"><i class="fa fa-cog"></i>Item List</a></li>
          </ul>
        </li>
        <!-- Menu 3 -->
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="customer-list.php"><i class="fa fa-cog"></i>Customers List</a></li>
          </ul>
        </li>
